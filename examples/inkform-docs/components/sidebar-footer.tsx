 ...
 * `ThemeToggle` button (which Galley doesn't render in the header at all, to
...
function ThemeTrio() {
  ...
  return (
    <div className="fw-galley-theme-trio" role="group" aria-label="Theme preference">
      <button
        type="button"
...
function LanguageMenu() {
  ...
  return (
    <div className="fw-galley-lang" ref={rootRef}>
      <button
        type="button"
        className="fw-galley-lang-trigger"
        onClick={() => setOpen((o) => !o)}
        aria-expanded={open}
        aria-haspopup="menu"
      >
      ...
      {open ? (
        <div className="fw-galley-lang-menu" role="menu">
          <button type="button" role="menuitemradio" aria-checked="true" className="fw-galley-lang-option" onClick={() => setOpen(false)}>
            English
          </button>
        </div>
      ) : null}
...
export function SidebarFooter() {
  return (
    <div className="fw-galley-sidebar-footer">
      <LanguageMenu />
      <ThemeTrio />
    </div>
  );
