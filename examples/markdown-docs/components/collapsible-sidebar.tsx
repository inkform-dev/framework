...
/**
 * Mono's own sidebar — NOT the framework's shared `Sidebar` component.
 *
...
export function CollapsibleSidebar({ title, groups, footer }: CollapsibleSidebarProps): ReactNode {
  ...
  if (collapsed) {
    return (
      <div className="fw-mono-sidebar-rail">
        <button
          type="button"
          className="fw-mono-sidebar-toggle"
  ...
  return (
    <aside className="fw-sidebar">
      <div className="fw-sidebar-header fw-mono-sidebar-heading">
        <span className="fw-mono-sidebar-heading-text">{title}</span>
        <button
          type="button"
          className="fw-mono-sidebar-toggle"
