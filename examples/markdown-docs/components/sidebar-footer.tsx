 ...
 * `ThemeToggle` button (which Mono doesn't render in the header at all, to
...
function ThemeTrio() {
  ...
  return (
    <div className="fw-mono-theme-trio" role="group" aria-label="Theme preference">
      <button
        type="button"
...
function LanguageMenu() {
  ...
  return (
    <div className="fw-mono-lang" ref={rootRef}>
      <button
        type="button"
        className="fw-mono-lang-trigger"
        onClick={() => setOpen((o) => !o)}
        aria-expanded={open}
        aria-haspopup="menu"
      >
      ...
      {open ? (
        <div className="fw-mono-lang-menu" role="menu">
          <button type="button" role="menuitemradio" aria-checked="true" className="fw-mono-lang-option" onClick={() => setOpen(false)}>
            English
          </button>
        </div>
      ) : null}
...
export function SidebarFooter() {
  return (
    <div className="fw-mono-sidebar-footer">
      <LanguageMenu />
      <ThemeTrio />
    </div>
  );
