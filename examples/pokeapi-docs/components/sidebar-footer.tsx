 ...
 * `ThemeToggle` button (which Aurora doesn't render in the header at all, to
...
function ThemeTrio() {
  ...
  return (
    <div className="fw-aurora-theme-trio" role="group" aria-label="Theme preference">
      <button
        type="button"
...
function LanguageMenu() {
  ...
  return (
    <div className="fw-aurora-lang" ref={rootRef}>
      <button
        type="button"
        className="fw-aurora-lang-trigger"
        onClick={() => setOpen((o) => !o)}
        aria-expanded={open}
        aria-haspopup="menu"
      >
      ...
      {open ? (
        <div className="fw-aurora-lang-menu" role="menu">
          <button type="button" role="menuitemradio" aria-checked="true" className="fw-aurora-lang-option" onClick={() => setOpen(false)}>
            English
          </button>
        </div>
      ) : null}
...
export function SidebarFooter() {
  return (
    <div className="fw-aurora-sidebar-footer">
      <LanguageMenu />
      <ThemeTrio />
    </div>
  );
