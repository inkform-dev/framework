...
/**
 * Canopy's own sidebar — NOT the framework's shared `Sidebar` component.
 *
...
export function CollapsibleSidebar({ title, groups, footer }: CollapsibleSidebarProps): ReactNode {
  ...
  if (collapsed) {
    return (
      <div className="fw-canopy-sidebar-rail">
        <button
          type="button"
          className="fw-canopy-sidebar-toggle"
  ...
  return (
    <aside className="fw-sidebar">
      <div className="fw-sidebar-header fw-canopy-sidebar-heading">
        <span className="fw-canopy-sidebar-heading-text">{title}</span>
        <button
          type="button"
          className="fw-canopy-sidebar-toggle"
