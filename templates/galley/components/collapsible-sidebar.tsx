...
/**
 * Galley's own sidebar — NOT the framework's shared `Sidebar` component.
 *
...
export function CollapsibleSidebar({ title, groups, footer }: CollapsibleSidebarProps): ReactNode {
  ...
  if (collapsed) {
    return (
      <div className="fw-galley-sidebar-rail">
        <button
          type="button"
          className="fw-galley-sidebar-toggle"
  ...
  return (
    <aside className="fw-sidebar">
      <div className="fw-sidebar-header fw-galley-sidebar-heading">
        <span className="fw-galley-sidebar-heading-text">{title}</span>
        <button
          type="button"
          className="fw-galley-sidebar-toggle"
