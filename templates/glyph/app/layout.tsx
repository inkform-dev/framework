...
/*
 * Glyph theme: monospace everywhere.
 * JetBrains Mono is loaded once into --font-mono; theme.css maps all three
 * font slots (--fw-font, --fw-font-heading, --fw-mono) to it — no separate
 * sans or serif voice, matching Linden's own all-monospace identity.
 */
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const name = config?.name ?? 'Glyph Docs';
  return {
