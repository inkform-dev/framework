...
export default async function Page({ params }: { params: Promise<{ slug?: string[] }> }) {
  ...
  return (
    <DocsShell
      ...
      sidebar={<Sidebar groups={sidebar} header={topBar.sidebarHeader} />}
      toc={headings.length > 0 ? <TocList headings={headings} /> : undefined}
      hideToc={headings.length === 0}
    >
      {/* float:right (theme.css) lets the H1 rendered by <Mdx> below wrap
          around this instead of needing to know the H1's height up front —
          see components/copy-page-button.tsx's doc comment. */}
      <div className="fw-harbor-page-head">
