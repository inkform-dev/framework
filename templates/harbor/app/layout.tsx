...
// weight, not a second typeface. Matches Harbor's Almond-inspired identity:
// a single, confident sans (the real site shows no distinct display serif),
// same one-voice approach as Birch.
const inter = Inter({
  subsets: ['latin'],
  variable: '--font-sans',
  display: 'swap',
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const name = config?.name ?? 'Harbor Docs';
  return {
