...
const ICON_MAP: Record<string, React.ComponentType<{ size?: number; strokeWidth?: number }>> = {
  ...
  download: Download,
  upload: Upload,
  // Meadow-specific additions — used for docs.json's group-level `icon`
  // (sidebar group headers, e.g. "Getting Started" / "Essentials"). This
  // map is per-template (not shared framework code), so extending it here
