...
/**
 * Shadcn's own sidebar — NOT the framework's shared `Sidebar` component.
 *
...
export function CollapsibleSidebar({ title, groups, footer }: CollapsibleSidebarProps): ReactNode {
  ...
  if (collapsed) {
    return (
      <div className="fw-shadcn-sidebar-rail">
        <button
          type="button"
          className="fw-shadcn-sidebar-toggle"
  ...
  return (
    <aside className="fw-sidebar">
      <div className="fw-sidebar-header fw-shadcn-sidebar-heading">
        <span className="fw-shadcn-sidebar-heading-text">{title}</span>
        <button
          type="button"
          className="fw-shadcn-sidebar-toggle"
