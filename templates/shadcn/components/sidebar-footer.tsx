 ...
 * `ThemeToggle` button (which Shadcn doesn't render in the header at all, to
...
function ThemeTrio() {
  ...
  return (
    <div className="fw-shadcn-theme-trio" role="group" aria-label="Theme preference">
      <button
        type="button"
...
function LanguageMenu() {
  ...
  return (
    <div className="fw-shadcn-lang" ref={rootRef}>
      <button
        type="button"
        className="fw-shadcn-lang-trigger"
        onClick={() => setOpen((o) => !o)}
        aria-expanded={open}
        aria-haspopup="menu"
      >
      ...
      {open ? (
        <div className="fw-shadcn-lang-menu" role="menu">
          <button type="button" role="menuitemradio" aria-checked="true" className="fw-shadcn-lang-option" onClick={() => setOpen(false)}>
            English
          </button>
        </div>
      ) : null}
...
export function SidebarFooter() {
  return (
    <div className="fw-shadcn-sidebar-footer">
      <LanguageMenu />
      <ThemeTrio />
    </div>
  );
