...
/**
 * Yucca's own sidebar — NOT the framework's shared `Sidebar` component.
 *
...
export function CollapsibleSidebar({ title, groups, footer }: CollapsibleSidebarProps): ReactNode {
  ...
  if (collapsed) {
    return (
      <div className="fw-yucca-sidebar-rail">
        <button
          type="button"
          className="fw-yucca-sidebar-toggle"
  ...
  return (
    <aside className="fw-sidebar">
      <div className="fw-sidebar-header fw-yucca-sidebar-heading">
        <span className="fw-yucca-sidebar-heading-text">{title}</span>
        <button
          type="button"
          className="fw-yucca-sidebar-toggle"
